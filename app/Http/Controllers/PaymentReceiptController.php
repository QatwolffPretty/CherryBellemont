...
{
    public function store(Request $request, Order $order, string $token, OrderNotifier $notifier): RedirectResponse
    {
        ...
        try {
            $order = DB::transaction(function () use ($order, $file, &$path): Order {
