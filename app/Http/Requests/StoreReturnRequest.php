...
class StoreReturnRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'images' => ['nullable', 'array', 'max:'.config('store.returns.maximum_return_images', 5)],
            'images.*' => ['image', 'mimes:jpg,jpeg,png,webp', 'max:'.((int) config('store.returns.maximum_return_image_size_mb', 5) * 1024)],
        ];
    }
}
