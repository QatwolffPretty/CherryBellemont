...
class Order extends Model
{
    ...
    protected $casts = ['subtotal' => 'decimal:2', 'total' => 'decimal:2', 'shipping_fee' => 'decimal:2', 'shipping_address' => 'array', 'stripe_paid_at'=>'datetime', 'shipped_at'=>'datetime', 'delivered_at'=>'datetime', 'cancelled_at'=>'datetime', 'stock_restored_at'=>'datetime'];
