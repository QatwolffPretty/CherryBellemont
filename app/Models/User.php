...
class User extends Authenticatable
{
    ...
    public function createdOwnerCompensationTransactions(): HasMany { return $this->hasMany(OwnerTransaction::class, 'created_by'); }
    public function postedOwnerCompensationTransactions(): HasMany { return $this->hasMany(OwnerTransaction::class, 'posted_by'); }
