...
{
    public function customer(ReturnRequest $returnRequest, string $event): void
    {
        ...
        $this->afterCommit(function () use ($returnRequest, $event, $recipient): void {
            try {
                Notification::route('mail', $recipient)->notify(new ReturnCustomerNotification($returnRequest, $event));
