<x-layouts.admin title="Accounting Overview | Cherry Bellemont">
    <x-admin.section width="7xl">
        ...
        <div class="mt-8 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
            @foreach(['gross_sales' => 'Gross Sales', 'discounts' => 'Discounts', 'refunds' => 'Refunds', 'net_sales' => 'Net Sales', 'other_income' => 'Other Income', 'cost_of_goods_sold' => 'Cost of Goods Sold', 'operating_expenses' => 'Operating Expenses', 'owner_compensation' => 'Owner Compensation', 'gross_profit' => 'Gross Profit', 'net_profit' => 'Net Profit', 'business_cash' => 'Business Cash Balance'] as $key => $label)
