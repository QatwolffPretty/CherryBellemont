...
<section {{ $attributes->class('newsletter-feature') }} data-newsletter-feature aria-labelledby="newsletter-heading">
    ...
    <div class="newsletter-feature-inner">
        <div class="newsletter-feature-copy">
            <p class="newsletter-feature-eyebrow">Exclusive Access</p>
            <h2 id="newsletter-heading" class="newsletter-feature-heading">Join the Cherry Bellemont Community</h2>
            <p class="newsletter-feature-description">Be the first to discover new arrivals, exclusive collections, private promotions, styling inspiration, and exclusive Cherry Bellemont updates delivered directly to your inbox.</p>
        </div>
